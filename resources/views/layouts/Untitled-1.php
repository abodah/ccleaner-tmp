<div class="h-screen w-screen">
    <div class="flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0">
        <div class="flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0" style="height: 500px">
            ...
            <div class="hidden md:block md:w-1/2 rounded-r-lg" style="background: url('https://unsplash.com/photos/ViR3a0rx18w'); background-size: cover; background-position: center center;"></div>
        </div>
    </div>
</div>

class="flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0"  style="height: 620px"